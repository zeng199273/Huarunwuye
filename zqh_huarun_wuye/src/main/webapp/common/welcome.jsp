...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
    <legend style="text-align: center">欢迎访问华润物业管理系统</legend>
</fieldset>
<div style="padding: 20px; background-color: #F2F2F2;">
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md6">
            <div class="layui-card">
                <div class="layui-card-header">
                    <img src="<%=contextPath%>/images/ic_system.png" alt="">
                    &nbsp;&nbsp;系统详细信息
                </div>
                ...
                <ul class="layui-timeline">
                    <li class="layui-timeline-item">
                        ...
                        <div class="layui-timeline-content layui-text">
                            <div class="layui-timeline-title">开发作者 By：北大青鸟T275</div>
                        </div>
                    </li>
                    <li class="layui-timeline-item">
                        <i class="layui-icon layui-timeline-axis"></i>
                    ...
                    <li class="layui-timeline-item">
                        <i class="layui-icon layui-timeline-axis"></i>
                        <div class="layui-timeline-content layui-text">
                            <div class="layui-timeline-title">后端使用技术框架：SpringBoot+SpringMVC+Mybatis</div>
                        </div>
                    </li>
                    <li class="layui-timeline-item">
        ...
        <div class="layui-col-md6">
            <div class="layui-card">
                <div class="layui-card-header">
                    <img src="<%=contextPath%>/images/ic_time.png" alt=""> &nbsp;&nbsp;
